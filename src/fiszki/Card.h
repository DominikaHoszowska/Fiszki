...
public:
    ...
    //UpdateCard:
    void updateCard(double);//!<akutalizuje fiszkę
    void updateEF( double); //!< aktulizuje wskaźnik uczenia
    void updateI();//!< aktulizuje I
    void updateTimeToRepeat();//!< aktulizuje czas następnej nauki
    void updateCardDB(); //!<akutalizuje fiszkę w bazie danych
